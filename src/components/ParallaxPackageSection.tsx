...
import { MapPin, ChevronRight, Calendar, Plus, X } from 'lucide-react';
import { motion } from 'framer-motion';
import { useInView } from 'react-intersection-observer';
import { pricingService, HuntData } from '../services/pricingService';

interface ParallaxPackageSectionProps {
  darkMode: boolean;
}


const ParallaxPackageSection: React.FC<ParallaxPackageSectionProps> = ({ darkMode }) => {
...
export default ParallaxPackageSection;
